...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "👋 Доброго дня! Якщо у вас виникли труднощі пов'язані з рекламою на сторінці, будь-ласка, опишіть проблему максимально розвернуто в одному повідомленні.")
