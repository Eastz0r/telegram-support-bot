...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "👋 Доброго дня! Цей бот призначений для запуску рекламних кампаній СН в регіонах. Надішліть посилання на публікацію та додайте коментар з побажаннями щодо тривалості рекламної кампанії та аудиторії яку хочете охопити.")
